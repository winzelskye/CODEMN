...
public class DatabaseManager : MonoBehaviour
{
    ...
    void SeedData()
    {
        ...
        db.Insert(new CharacterStats { characterName = "Michael", health = 0, maxHealth = 100, attack = 15, defense = 10, speed = 7, bitpointRate = 10 });
        ...
        db.Insert(new AttackData { attackName = "Pictionary", damage = 13, unlockLevel = 2, isUnlocked = 0, isSpecial = 0, isSkill = 0, forCharacter = "both", bitpointCost = 5 });
        ...
        db.Insert(new AttackData { attackName = "Protection EX", damage = -40, unlockLevel = 3, isUnlocked = 0, isSpecial = 1, isSkill = 1, forCharacter = "Esther", bitpointCost = 50 });

        // Levels
        db.Insert(new LevelData { id = 0, levelName = "Tutorial", isUnlocked = 1, isCompleted = 0 });
        db.Insert(new LevelData { id = 1, levelName = "Level 1", isUnlocked = 0, isCompleted = 0 });
